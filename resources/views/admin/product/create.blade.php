                ...
                <div class="card-body">
                    <form action="{{ route('admin.product.create') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="short_description" class="form-control" cols="30" rows="4" maxlength="255" required>{{ old('short_description') }}</textarea>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="subcategory_id" class="form-select">
                                    ...
                                    @foreach ($subCategories as $category)
                                        <option value="{{ $category->id }}" {{ old('subcategory_id') == $category->id ? 'selected' : '' }}>{{ $category->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-check mb-3">
                            <input type="checkbox" name="status" value="1" class="form-check-input" {{ old('status', true) ? 'checked' : '' }}>
                        ...
                        {{-- Featured --}}
                        <div class="form-check mb-3">
                            <input type="checkbox" name="is_featured" value="1" class="form-check-input" {{ old('is_featured', true) ? 'checked' : '' }}>
